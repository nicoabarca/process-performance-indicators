"""
Derivable Interval Event Log - Indicator Analysis Example

This script demonstrates indicator analysis on a derivable interval event log,
where activity intervals (start/end times) can be derived from lifecycle transitions.

Dataset characteristics:
- Has lifecycle transitions (start/complete)
- No explicit instance IDs (must be derived from matching start/complete pairs)
...
DATASET_PATH = "derivable_interval_event_log.csv"
FORMATTED_DATASET_PATH = "derivable_interval_event_log_formatted.csv"
RESULTS_CSV_PATH = "derivable_interval_event_log_results.csv"
SUMMARY_CSV_PATH = "derivable_interval_event_log_summary.csv"

# Step 2: Map your column names to standard names
# Derivable interval log: has lifecycle transitions, instances derived from start/complete matching
...
def build_indicator_arguments_simple() -> IndicatorArguments:
    ...
    return IndicatorArguments(
        ...
        start_time=pd.Timestamp("2025-01-01 10:00:00"),  # Dataset starts at 2025-01-01 10:00:06
        end_time=pd.Timestamp("2025-01-01 10:21:00"),  # Dataset ends at 2025-01-01 10:20:45
