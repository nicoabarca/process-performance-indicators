"""
Explicit Interval Event Log - Indicator Analysis Example

This script demonstrates indicator analysis on an explicit interval event log,
where activity instances are explicitly identified with instance IDs.

Dataset characteristics:
- Has lifecycle transitions (start/complete)
- Has explicit instance IDs (concept:instance)
...
DATASET_PATH = "explicit_interval_event_log.csv"
FORMATTED_DATASET_PATH = "explicit_interval_event_log_formatted.csv"
RESULTS_CSV_PATH = "explicit_interval_event_log_results.csv"
SUMMARY_CSV_PATH = "explicit_interval_event_log_summary.csv"

# Step 2: Map your column names to standard names
# Explicit interval log: has lifecycle transitions AND explicit instance IDs
...
def build_indicator_arguments_simple() -> IndicatorArguments:
    ...
    return IndicatorArguments(
        ...
        instance_id="i_1",  # Replace with an instance ID from your log
        ...
        start_time=pd.Timestamp("2025-01-01 10:00:00"),  # Dataset starts at 2025-01-01 10:00:00
        end_time=pd.Timestamp("2025-01-01 10:17:00"),  # Dataset ends at 2025-01-01 10:16:19
