...
def expected_activity_count(event_log: pd.DataFrame, case_ids: list[str] | set[str]) -> int | float:
    """
    The expected number of activities in the event log for a given list or set of case ids.
...
def activity_instance_count(event_log: pd.DataFrame, case_ids: list[str] | set[str]) -> int:
    """
    Counts the number of activity instances in the event log for a given list or set of case ids.
...
def expected_activity_instance_count(
    ...
    """
    The expected number of activity instances in the event log for a given list or set of case ids.
    ...
    """
    activity_instance_count = cases_general_indicators.activity_instance_count(event_log, case_ids)
    return activity_instance_count / case_count(event_log, case_ids)
