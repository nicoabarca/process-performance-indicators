...
def activity_count(event_log: pd.DataFrame, case_id: str) -> int:
    """
    Counts the number of different activities in the event log of a given case based on id.
...
def human_resource_count(event_log: pd.DataFrame, case_id: str) -> int:
    """
    Counts the number of different human resources in the event log of a given case based on id.
...
def resource_count(event_log: pd.DataFrame, case_id: str) -> int:
    """
    Counts the number of different resources in the event log of a given case based on id.
...
def role_count(event_log: pd.DataFrame, case_id: str) -> int:
    """
    Counts the number of different roles in the event log of a given case based on id.
